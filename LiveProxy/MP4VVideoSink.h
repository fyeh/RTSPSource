...
*/
class MP4VVideoSink : public MyVideoSink {

// static methods
public:
	static MP4VVideoSink * createNew(UsageEnvironment& env, MediaSubsession& subsession, char const* streamId = NULL);
...
public:
	...
	virtual ~MP4VVideoSink();


protected:
	MP4VVideoSink(UsageEnvironment& env, MediaSubsession& subsession, char const* streamId);
